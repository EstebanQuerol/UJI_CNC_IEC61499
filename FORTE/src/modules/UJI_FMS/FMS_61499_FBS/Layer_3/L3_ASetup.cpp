...
const CStringDictionary::TStringId FORTE_L3_ASetup::scm_anDataInputTypeIds[] = {g_nStringIdARRAY, 4, g_nStringIdUINT, g_nStringIdUSINT};

const CStringDictionary::TStringId FORTE_L3_ASetup::scm_anDataOutputNames[] = {g_nStringIdPartInfoP, g_nStringIdSetup};

const CStringDictionary::TStringId FORTE_L3_ASetup::scm_anDataOutputTypeIds[] = {g_nStringIdARRAY, 4, g_nStringIdUINT, g_nStringIdSTRING};
...
const TDataIOID FORTE_L3_ASetup::scm_anEOWith[] = {0, 1, 255, 0, 255};
const TForteInt16 FORTE_L3_ASetup::scm_anEOWithIndexes[] = {0, 3, -1};
