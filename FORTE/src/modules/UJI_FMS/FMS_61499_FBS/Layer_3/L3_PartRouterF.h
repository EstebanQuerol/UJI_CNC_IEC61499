...
#ifndef _L3_PARTROUTERF_H_
#define _L3_PARTROUTERF_H_
...
class FORTE_L3_PartRouterF: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_L3_PartRouterF)
...
public:
  FORTE_L3_PartRouterF(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_L3_PartRouterF(){};
