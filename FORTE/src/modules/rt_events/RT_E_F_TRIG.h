 ...
 ***
 *** Name: RT_E_F_TRIG
 *** Description: Boolean falling adge detection
 *** Version: 
 ***     0.0: 2008-07-10/4DIAC-IDE - 4DIAC-Consortium - null
 *************************************************************************/

#ifndef _RT_E_F_TRIG_H_
#define _RT_E_F_TRIG_H_

#include "rtesingle.h"
#include <forte_time.h>
#include <forte_bool.h>

class FORTE_RT_E_F_TRIG: public CRTEventSingle{
  DECLARE_FIRMWARE_FB(FORTE_RT_E_F_TRIG)
