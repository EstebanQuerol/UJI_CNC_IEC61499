...
const SCFB_FBConnectionData FORTE_L3_ProcessPlan::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_MachineAllocator, g_nStringIdIND1), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdREQ), 6},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdCNF), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdREQ), CCompositeFB::scm_nAdapterMarker |1},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedPartHDLR, g_nStringIdStart), 4, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_DELAY_1, g_nStringIdSTART), 7},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedPartHDLR, g_nStringIdStop), 4, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_DELAY_1, g_nStringIdSTOP), 7},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_DELAY_1, g_nStringIdEO), 7, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedPartHDLR, g_nStringIdTimeout), 4},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdINITO), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdINIT), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdINITO), 6, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdINITO), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdCNF1), 8, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdRSP2), 0},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdIND2), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdREQ1), 8},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdIND), CCompositeFB::scm_nAdapterMarker |1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdREQ), 8},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdCNF), 8, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdRSP), CCompositeFB::scm_nAdapterMarker |1},
};
...
const SCFB_FBConnectionData FORTE_L3_ProcessPlan::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_MachineAllocator, g_nStringIdPartIDOut), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdPartID), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_MachineAllocator, g_nStringIdSetupID), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdSetupID), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_MachineAllocator, g_nStringIdMID), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdMID), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdPartInfo), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdPartInfoP), CCompositeFB::scm_nAdapterMarker |1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdMID2), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdMID), CCompositeFB::scm_nAdapterMarker |1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdOPIDS), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdOPIDS), CCompositeFB::scm_nAdapterMarker |1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdOPParams), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdOPParams), CCompositeFB::scm_nAdapterMarker |1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdFixture), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdFixture), CCompositeFB::scm_nAdapterMarker |1},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedPartHDLR, g_nStringIdDelay), 4, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdE_DELAY_1, g_nStringIdDT), 7},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdQO), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdQI), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdQO), 6, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdQO), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdPartIDOut), 8, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdPartIDIn2), 0},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_ASetup, g_nStringIdPartInfoS), CCompositeFB::scm_nAdapterMarker |1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedSetupHDLR_1, g_nStringIdPartInfo), 8},
};
...
const SCFB_FBFannedOutConnectionData FORTE_L3_ProcessPlan::scm_astFannedOutDataConnections[] = {
  ...
  {14, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdPartIDIn3), 0},
  {16, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdMID), 0},
  {24, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_CompletedPartHDLR, g_nStringIdDeadlineIn), 4},
  {36, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdFamily), 0},
  {36, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdFamily), 6},
  {37, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_PPTable, g_nStringIdType), 0},
  {37, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL3_SetupTable, g_nStringIdType), 6},
};
