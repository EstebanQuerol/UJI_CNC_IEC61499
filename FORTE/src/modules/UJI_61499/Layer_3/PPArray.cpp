...
void PPArray::Initilizate()
{
	if (!sm_bInitialized){
		...
		sm_aPParray[nFamily - 1][nType - 1] = ProcessPlan(2, nFamily, nType);
			//Setup 1
			nSetupIndex = 1;
			sm_aPParray[nFamily - 1][nType - 1].addSetup(nSetupIndex, 3, "Fixture1");
				//Operation 1
			...
			//Setup 2
			nSetupIndex = 2;
			sm_aPParray[nFamily - 1][nType - 1].addSetup(nSetupIndex, 3, "Fixture2");
				//Operation 1
		...
		sm_aPParray[nFamily - 1][nType - 1] = ProcessPlan(2, nFamily, nType);
			//Setup 1
			nSetupIndex = 1;
			sm_aPParray[nFamily - 1][nType - 1].addSetup(nSetupIndex, 3, "Fixture11");
				//Operation 1
			...
			//Setup 2
			nSetupIndex = 2;
			sm_aPParray[nFamily - 1][nType - 1].addSetup(nSetupIndex, 3, "Fixture22");
				//Operation 1
