...
const CStringDictionary::TStringId FORTE_L3_L2CommPlug::scm_anDataOutputNames[] = {g_nStringIdPartInfoP, g_nStringIdMID, g_nStringIdSetup};

const CStringDictionary::TStringId FORTE_L3_L2CommPlug::scm_anDataOutputTypeIds[] = {g_nStringIdARRAY, 3, g_nStringIdUINT, g_nStringIdUSINT, g_nStringIdSTRING};
...
const TDataIOID FORTE_L3_L2CommPlug::scm_anEOWith[] = {0, 1, 2, 255, 1, 255};
const TForteInt16 FORTE_L3_L2CommPlug::scm_anEOWithIndexes[] = {0, 4, -1};
