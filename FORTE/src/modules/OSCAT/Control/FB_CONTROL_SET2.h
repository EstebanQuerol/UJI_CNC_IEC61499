...
#ifndef _FB_CONTROL_SET2_H_
#define _FB_CONTROL_SET2_H_

#include <basicfb.h>
#include <forte_real.h>

class FORTE_FB_CONTROL_SET2: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_FB_CONTROL_SET2)
...
private:
  ...
  static const SInternalVarsInformation scm_stInternalVars;
   ...
   FORTE_BASIC_FB_DATA_ARRAY(3, 9, 5, 1, 0);
...
public:
  FORTE_FB_CONTROL_SET2(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_FB_CONTROL_SET2(){};
