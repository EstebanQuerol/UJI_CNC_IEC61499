...
#ifndef _FB_FT_PIDWL_H_
#define _FB_FT_PIDWL_H_
...
class FORTE_FB_FT_PIDWL: public CCompositeFB{
  DECLARE_FIRMWARE_FB(FORTE_FB_FT_PIDWL)
...
public:
  COMPOSITE_FUNCTION_BLOCK_CTOR(FORTE_FB_FT_PIDWL){
  };

  virtual ~FORTE_FB_FT_PIDWL(){};
