...
#ifndef _FB_FT_TN64_H_
#define _FB_FT_TN64_H_
...
class FORTE_FB_FT_TN64: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_FB_FT_TN64)
...
public:
  FORTE_FB_FT_TN64(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_FB_FT_TN64(){};
