...
#ifndef _FB_MUL_DINT_H_
#define _FB_MUL_DINT_H_

#include <basicfb.h>
#include <forte_dint.h>


class FB_MUL_DINT: public CBasicFB{
  DECLARE_FIRMWARE_FB(FB_MUL_DINT)
...
public:
  FB_MUL_DINT(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  virtual ~FB_MUL_DINT();
