...
#ifndef _FB_MUL_INT_H_
#define _FB_MUL_INT_H_

#include <basicfb.h>
#include <forte_int.h>


class FB_MUL_INT: public CBasicFB{
  DECLARE_FIRMWARE_FB(FB_MUL_INT)
...
public:
  FB_MUL_INT(const CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes);
  virtual ~FB_MUL_INT();
