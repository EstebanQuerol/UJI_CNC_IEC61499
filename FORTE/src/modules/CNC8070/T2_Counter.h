...
#ifndef _T2_COUNTER_H_
#define _T2_COUNTER_H_
...
class FORTE_T2_Counter: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_T2_Counter)
...
private:
  ...
  static const SInternalVarsInformation scm_stInternalVars;
   ...
   FORTE_BASIC_FB_DATA_ARRAY(2, 2, 2, 1, 1);
...
public:
  FORTE_T2_Counter(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
           &scm_stInternalVars, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_T2_Counter(){};
