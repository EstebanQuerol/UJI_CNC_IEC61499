...
#ifndef _L1_FROUNDHOLE_H_
#define _L1_FROUNDHOLE_H_
...
class FORTE_L1_FRoundHole : public CFunctionBlock, public L1_GENFeature{
  DECLARE_FIRMWARE_FB(FORTE_L1_FRoundHole)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_L1_FRoundHole){
  };

  virtual ~FORTE_L1_FRoundHole(){};
