...
class FORTE_L1_FSlot : public CFunctionBlock, public L1_GENFeature{
  DECLARE_FIRMWARE_FB(FORTE_L1_FSlot)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_L1_FSlot){
  };

  virtual ~FORTE_L1_FSlot(){};
