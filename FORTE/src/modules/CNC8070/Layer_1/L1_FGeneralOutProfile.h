...
#ifndef _L1_FGENERALOUTPROFILE_H_
#define _L1_FGENERALOUTPROFILE_H_
...
class FORTE_L1_FGeneralOutProfile : public CFunctionBlock, public L1_GENFeature{
  DECLARE_FIRMWARE_FB(FORTE_L1_FGeneralOutProfile)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_L1_FGeneralOutProfile){
  };

  virtual ~FORTE_L1_FGeneralOutProfile(){};
