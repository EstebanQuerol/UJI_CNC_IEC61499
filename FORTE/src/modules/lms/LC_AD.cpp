...
DEFINE_FIRMWARE_FB(FORTE_LC_AD, g_nStringIdLC_AD)

const CStringDictionary::TStringId FORTE_LC_AD::scm_anDataInputNames[] = {g_nStringIdQI, g_nStringIdPORT};

const CStringDictionary::TStringId FORTE_LC_AD::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdUINT};

const CStringDictionary::TStringId FORTE_LC_AD::scm_anDataOutputNames[] = {g_nStringIdQO, g_nStringIdRD};

const CStringDictionary::TStringId FORTE_LC_AD::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL, g_nStringIdUINT};

const TForteInt16 FORTE_LC_AD::scm_anEIWithIndexes[] = {0, 3};
const TDataIOID FORTE_LC_AD::scm_anEIWith[] = {0, 1, 255, 0, 255};
const CStringDictionary::TStringId FORTE_LC_AD::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdREQ};

const TDataIOID FORTE_LC_AD::scm_anEOWith[] = {0, 255, 0, 1, 255};
const TForteInt16 FORTE_LC_AD::scm_anEOWithIndexes[] = {0, 2, -1};
const CStringDictionary::TStringId FORTE_LC_AD::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF};

const SFBInterfaceSpec FORTE_LC_AD::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_LC_AD::scm_astInternalFBs[] = {
  {g_nStringIdL_AD, g_nStringIdL_AD},
  {g_nStringIdL_S_PORT, g_nStringIdL_S_PORT},
};

const SCFB_FBParameter FORTE_LC_AD::scm_astParamters[] = {
  {1, g_nStringIdT, "5"},
};

const SCFB_FBConnectionData FORTE_LC_AD::scm_astEventConnections[] = {
...
const SCFB_FBConnectionData FORTE_LC_AD::scm_astDataConnections[] = {
...
const SCFB_FBFannedOutConnectionData FORTE_LC_AD::scm_astFannedOutDataConnections[] = {
  {5, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdL_AD, g_nStringIdPORT), 0},
};

const SCFB_FBNData FORTE_LC_AD::scm_stFBNData = {
