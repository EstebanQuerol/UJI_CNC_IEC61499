...
class FORTE_F_STRING_TO_LWORD: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_F_STRING_TO_LWORD)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_F_STRING_TO_LWORD){
  };

  virtual ~FORTE_F_STRING_TO_LWORD(){};
