...
class FORTE_F_DWORD_TO_UDINT: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FORTE_F_DWORD_TO_UDINT)
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_F_DWORD_TO_UDINT){
  };

  virtual ~FORTE_F_DWORD_TO_UDINT(){};
