...
const TDataIOID FORTE_F_UDINT_TO_LWORD::scm_anEIWith[] = {0, 255};
const CStringDictionary::TStringId FORTE_F_UDINT_TO_LWORD::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_F_UDINT_TO_LWORD::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_F_UDINT_TO_LWORD::scm_anEOWithIndexes[] = {0, -1};
