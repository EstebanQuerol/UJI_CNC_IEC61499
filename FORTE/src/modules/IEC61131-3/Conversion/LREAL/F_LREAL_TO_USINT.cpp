 ...
 ***
 *** Name: F_LREAL_TO_USINT
 *** Description: convert LREAL to USINT
 *** Version: 
...
const TDataIOID FORTE_F_LREAL_TO_USINT::scm_anEIWith[] = {0, 255};
const CStringDictionary::TStringId FORTE_F_LREAL_TO_USINT::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_F_LREAL_TO_USINT::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_F_LREAL_TO_USINT::scm_anEOWithIndexes[] = {0, -1};
