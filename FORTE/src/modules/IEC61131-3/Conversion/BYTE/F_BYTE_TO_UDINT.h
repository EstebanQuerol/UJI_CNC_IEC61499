...
#ifndef _F_BYTE_TO_UDINT_H_
#define _F_BYTE_TO_UDINT_H_

#include <funcbloc.h>
#include <forte_byte.h>
#include <forte_udint.h>

class FORTE_F_BYTE_TO_UDINT: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_F_BYTE_TO_UDINT){
  };

  virtual ~FORTE_F_BYTE_TO_UDINT(){};
