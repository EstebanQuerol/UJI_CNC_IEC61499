...
const TDataIOID FORTE_F_BOOL_TO_INT::scm_anEIWith[] = {0, 255};
const CStringDictionary::TStringId FORTE_F_BOOL_TO_INT::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_F_BOOL_TO_INT::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_F_BOOL_TO_INT::scm_anEOWithIndexes[] = {0, -1};
