...
#ifndef _F_WSTRING_TO_USINT_H_
#define _F_WSTRING_TO_USINT_H_

#include <funcbloc.h>
#include <forte_usint.h>
#include <forte_wstring.h>

class FORTE_F_WSTRING_TO_USINT: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_F_WSTRING_TO_USINT){
  };

  virtual ~FORTE_F_WSTRING_TO_USINT(){};
