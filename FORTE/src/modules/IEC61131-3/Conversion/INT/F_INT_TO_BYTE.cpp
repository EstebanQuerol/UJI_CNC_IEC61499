...
const TDataIOID FORTE_F_INT_TO_BYTE::scm_anEIWith[] = {0, 255};
const CStringDictionary::TStringId FORTE_F_INT_TO_BYTE::scm_anEventInputNames[] = {g_nStringIdREQ};

const TDataIOID FORTE_F_INT_TO_BYTE::scm_anEOWith[] = {0, 255};
const TForteInt16 FORTE_F_INT_TO_BYTE::scm_anEOWithIndexes[] = {0, -1};
