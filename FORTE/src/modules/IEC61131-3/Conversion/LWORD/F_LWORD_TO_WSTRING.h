...
#ifndef _F_LWORD_TO_WSTRING_H_
#define _F_LWORD_TO_WSTRING_H_

#include <funcbloc.h>
#include <forte_wstring.h>
#include <forte_lword.h>

class FORTE_F_LWORD_TO_WSTRING: public CFunctionBlock{
...
public:
  FUNCTION_BLOCK_CTOR(FORTE_F_LWORD_TO_WSTRING){
  };

  virtual ~FORTE_F_LWORD_TO_WSTRING(){};
