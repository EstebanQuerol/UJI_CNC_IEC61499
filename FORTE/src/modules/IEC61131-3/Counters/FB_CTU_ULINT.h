...
#ifndef _FB_CTU_ULINT_H_
#define _FB_CTU_ULINT_H_
...
class FB_CTU_ULINT: public CFunctionBlock{
  DECLARE_FIRMWARE_FB(FB_CTU_ULINT)
...
public:
  FUNCTION_BLOCK_CTOR(FB_CTU_ULINT){};
  virtual ~FB_CTU_ULINT(){};
