...
inline const CIEC_STRING LREAL_TO_STRING(const CIEC_LREAL &pa_roVal){
	...
	pa_roVal.toString(pacBuffer, CIEC_LREAL::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_LREAL::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING REAL_TO_STRING(const CIEC_REAL &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_REAL::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_REAL::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING TIME_TO_STRING(const CIEC_TIME &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_TIME::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_TIME::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING BOOL_TO_STRING(const CIEC_BOOL &pa_roVal){
	CIEC_STRING string;
	string.reserve(CIEC_BOOL::scm_unMaxStringBufSize);
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_BOOL::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_BOOL::scm_unMaxStringBufSize);
	return string;
}

#ifdef FORTE_USE_WSTRING_DATATYPE
inline const CIEC_WSTRING BOOL_TO_WSTRING(const CIEC_BOOL &pa_roVal){
  return pa_roVal ? CIEC_WSTRING("true") : CIEC_WSTRING("false");
}
#endif
...
inline const CIEC_STRING BYTE_TO_STRING(const CIEC_BYTE &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_BYTE::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_BYTE::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING DINT_TO_STRING(const CIEC_DINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_DINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_DINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING DWORD_TO_STRING(const CIEC_DWORD &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_DWORD::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_DWORD::scm_unMaxStringBufSize);
	return string;
}

#ifdef FORTE_USE_WSTRING_DATATYPE
inline const CIEC_WSTRING DWORD_TO_WSTRING(const CIEC_DWORD &pa_roVal){
  CIEC_WSTRING wstring;
  wstring.reserve(CIEC_DWORD::scm_unMaxStringBufSize);
  char *pacBuffer = wstring.getValue();
  pa_roVal.toString(pacBuffer, CIEC_DWORD::scm_unMaxStringBufSize);
  wstring.assign(pacBuffer,CIEC_DWORD::scm_unMaxStringBufSize);
  return wstring;
}
#endif
...
inline const CIEC_STRING LWORD_TO_STRING(const CIEC_LWORD &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_LWORD::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_LWORD::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING UDINT_TO_STRING(const CIEC_UDINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_UDINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_UDINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING UINT_TO_STRING(const CIEC_UINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_UINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_UINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING ULINT_TO_STRING(const CIEC_ULINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_ULINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_ULINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING USINT_TO_STRING(const CIEC_USINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_USINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_USINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING WORD_TO_STRING(const CIEC_WORD &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_WORD::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_WORD::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING INT_TO_STRING(const CIEC_INT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_INT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_INT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING LINT_TO_STRING(const CIEC_LINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer,CIEC_LINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_LINT::scm_unMaxStringBufSize);
	return string;
}
...
inline const CIEC_STRING SINT_TO_STRING(const CIEC_SINT &pa_roVal){
	...
	char *pacBuffer = string.getValue();
	pa_roVal.toString(pacBuffer, CIEC_SINT::scm_unMaxStringBufSize);
	string.assign(pacBuffer,CIEC_SINT::scm_unMaxStringBufSize);
	return string;
}
