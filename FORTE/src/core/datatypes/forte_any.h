 ...
 *  @version 20081216/mmm -removed serialize, deserialize, serializeshort, deserializeshort, serializeValue,
 *  deserializeValue, serializeTag and deserializeTag
 *  @version 20081121/mmm - added EDataTypeTags, rearranged EDataTypes, removed getValue(), set setValue() public,
 *  added setValueComplex for complex datatypes, added set and get functions for simple datatypes, modified setValue,
 *  added union UAnyData for simple datatypes, removed castFrom, serialize function don't has to be virtual
 *  @version 20081121/mmm - removed getValue, getValueComplex and castFrom
 *  @version 20081112/mmm - added m_eDataTypeId for datatype identification and
 *              changed data representation to union; implementing corresponding setValue and
 *              getValue methods, constructor
 *  @version 20070307/az - changed serialization code for supporting also the
 *                         Serialization of arrays.
 *  @version 20061107/gebenh - moved serializedouble() and
 *                             deserializedouble() to CIEC_LREAL
 *  @version 20060322/tstras - isFacadeDataType() method added
